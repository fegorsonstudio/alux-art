...
const ALLOWED_CATEGORIES = new Set(["portrait", "editorial", "corporate", "glamour", "wedding", "maternity", "fantasy", "boudoir", "street", "call_to_bar", "nursing_induction", "photo_upgrade", "trending", "fashion_brand", "other"]);
